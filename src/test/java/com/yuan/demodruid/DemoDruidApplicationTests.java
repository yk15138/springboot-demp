...
public class DemoDruidApplicationTests {
    ...
    public void test() {
        ...
        List<MpUser> mpUserList = mpUserService.list(new QueryWrapper<MpUser>()
                .eq("address", "beijing").last(String.format("limit %s, %s", start, pageSize)));
        System.out.println(mpUserList);
    }
